            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid md:grid-cols-4 gap-12 mb-16">
                        ...
                        <ul className="space-y-3">
                            {footerLinks.services.map((link) => (
                                <li key={link.label}>
                                    <a
                                        href={link.href}
                                        className="text-background/60 font-satoshi text-sm hover:text-green-600 transition-colors duration-300"
                                    >
                                        {link.label}
                                    </a>
                                </li>
                    ...
                    >
                        ...
                        <button className="mt-6 px-6 py-3 bg-background text-beige font-satoshi font-medium text-sm rounded-full hover:bg-background/90 transition-colors duration-300">
                            Start a Project
                        </button>
                    </motion.div>
                </div>
                ...
                >
                    <p className="text-background/50 font-satoshi text-sm">
                        © {currentYear} theperry. All rights reserved.
                    </p>
                    <div className="flex gap-6">
                        <a href="#" className="text-background/50 font-satoshi text-sm hover:text-background/80 transition-colors duration-300">
                            Privacy Policy
                        </a>
                        <a href="#" className="text-background/50 font-satoshi text-sm hover:text-background/80 transition-colors duration-300">
                            Terms of Service
